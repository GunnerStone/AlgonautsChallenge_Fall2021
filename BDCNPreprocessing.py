...
from BDCN.datasets.dataset import Data
import argparse
import BDCN.cfg as cfg
...
def parse_args():
    ...
    parser.add_argument('-m', '--model', type=str, default='BDCN/models/bdcn_pretrained_on_bsds500.pth', help='the model to test')
